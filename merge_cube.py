...
=========================================================
Study area : Mandya districts, Karnataka
...
# Local folder where the STACK tiles are downloaded after the Drive export
# finishes. ONLY the stack is pulled down locally; static + meteo stay on
# Drive untouched. Track B merges these local stack tiles with the local
# LISS-III output, so the stack needs to be on disk.
LOCAL_STACK_DIR = ROOT_DIR / "gee_stacks"
...
# =========================================================
# CROP CLASSES  (Mandya  — corrected from Punjab)
# =========================================================
